...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/MSYDJT', label: 'GitHub' },
    { link: 'https://msydjt.com/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    }，
    {
      ...
      name: '电影（密码：114514）',
      method: 'HEAD',
      target: 'https://movie.msydjt.com/',
      statusPageLink: 'https://movie.msydjt.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '电子邮件',
      method: 'HEAD',
      target: 'https://mail.msydjt.com/',
      statusPageLink: 'https://mail.msydjt.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: '工具聚合页',
      method: 'HEAD',
      target: 'https://tool.msydjt.com/',
      statusPageLink: 'https://tool.msydjt.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
